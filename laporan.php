...
<div role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation">
                <a class="navbar-brand" href="index.php"> <b>SEWA APA SAJA</b></a>
            </li>
            <li role="presentation">
                <a href="index.php?tab=barang">Barang</a>
            </li>
            <li role="presentation">
                <a href="index.php?tab=pemilik">Pemilik</a>
            </li>
            <li role="presentation">
